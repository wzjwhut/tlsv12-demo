...
public class ClientSSLContextFactory {
	...
	private String _pfxType = "JKS";
	private SSLContext _context;
	private String name = "";

	public ClientSSLContextFactory(URL clientUrl, String clientPass) {
	...
	public SSLContext newContext() throws Throwable {
